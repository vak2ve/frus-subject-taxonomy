...
def classify_entry_type(heading, sub_texts=None):
    ...
    known_geo = {
        ...
        'tanzania', 'thailand', 'togo', 'trinidad', 'trinidad and tobago',
        'tunisia', 'turkey', 'turkmenistan', 'uganda', 'ukraine',
        'united arab emirates', 'united kingdom', 'united states', 'uruguay',
        'ussr', 'uzbekistan', 'venezuela', 'vietnam', 'yemen',
        'yugoslavia', 'zambia', 'zimbabwe',
        # Historical names / alternate spellings
        'abyssinia', 'belgian congo', 'ceylon', 'formosa', 'gold coast',
        'great britain', 'ivory coast', 'malaya', 'manchukuo', 'persia',
        'palestine', 'rhodesia', 'rumania', 'siam', 'tanganyika',
        'transjordan', 'zanzibar', 'zaire', 'bechuanaland', 'basutoland',
        'nyasaland', 'togoland', 'dahomey', 'upper volta', 'british guiana',
        'dutch east indies', 'french west africa', 'french equatorial africa',
        'anglo-egyptian sudan', 'union of south africa',
        'republic of the congo', 'soviet union', 'argentine republic',
        # US states/territories that appear as geo entries
        'alaska', 'hawaii', 'puerto rico', 'guam', 'virgin islands',
        # Cities/sub-national regions/territories in FRUS indexes
        'berlin', 'hong kong', 'macau', 'macao', 'trieste', 'danzig',
        'tangier', 'vatican', 'tibet', 'kashmir', 'kurdistan', 'sahara',
        'aden', 'bermuda', 'gibraltar', 'greenland', 'newfoundland',
        'okinawa', 'panama canal', 'suez canal', 'manchuria',
        'goa', 'azores', 'liechtenstein', 'bessarabia', 'saar',
        'bukovina', 'cyrenaica', 'thrace', 'transylvania', 'silesia',
        'sinai', 'borneo', 'sumatra', 'java', 'hainan', 'crete',
        'curacao', 'martinique', 'nauru', 'ruhr', 'ruthenia', 'istria',
        'fiume', 'dodecanese', 'sakhalin', 'ryukyu', 'andorra',
        'monaco', 'san marino', 'spitsbergen', 'memel', 'tyrol',
        'corsica', 'sardinia', 'sicily', 'papua', 'timor',
        'tripolitania', 'rhineland', 'bornholm',
        # Broad regions
        'middle east', 'southeast asia', 'central america', 'latin america',
        'south asia', 'east asia', 'europe', 'africa', 'caribbean',
        'pacific islands', 'indian ocean', 'persian gulf', 'asia',
        'western europe', 'eastern europe', 'near east', 'far east',
        'indochina', 'french indochina', 'french guiana', 'west indies',
        'scandinavia', 'balkans', 'baltic states', 'levant',
        'maghreb', 'sahel', 'horn of africa', 'arab states',
        'south pacific', 'north africa', 'west africa', 'east africa',
        'central africa', 'southern africa',
        # Common FRUS index patterns for place-related entries
        'french union', 'british commonwealth', 'british empire',
